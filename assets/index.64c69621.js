 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hu{constructor(e,n,r,i,s){this.snapshotVersion=e,this.targetChanges=n,this.targetMismatches=r,this.documentUpdates=i,this.resolvedLimboDocuments=s}static createSynthesizedRemoteEventForCurrentChange(e,n){const r=new Map;return r.set(e,_o.createSynthesizedTargetChangeForCurrentChange(e,n)),new hu(z.min(),r,jw(),ln(),H())}}class _o{constructor(e,n,r,i,s){this.resumeToken=e,this.current=n,this.addedDocuments=r,this.modifiedDocuments=i,this.removedDocuments=s}static createSynthesizedTargetChangeForCurrentChange(e,n){return new _o(Me.EMPTY_BYTE_STRING,n,H(),H(),H())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function CP(t,e){return e}class We{constructor(e,n,r,i){this.server=e,this.local=n||e,this.writable=!!r,this.xform=i||CP}}let aa=null;function RP(t){return!Eu(t)||t.length<2?t:p_(t)}function m_(){if(aa)return aa;const t=[];t.push(new We("bucket")),t.push(new We("generation")),t.push(new We("metageneration")),t.push(new We("name","fullPath",!0));function e(s,o){return RP(o)}const n=new We("name");n.xform=e,t.push(n);function r(s,o){return o!==void 0?Number(o):o}const i=new We("size");return i.xform=r,t.push(i),t.push(new We("timeCreated")),t.push(new We("updated")),t.push(new We("md5Hash",null,!0)),t.push(new We("cacheControl",null,!0)),t.push(new We("contentDisposition",null,!0)),t.push(new We("contentEncoding",null,!0)),t.push(new We("contentLanguage",null,!0)),t.push(new We("contentType",null,!0)),t.push(new We("metadata","customMetadata",!0)),aa=t,aa}function NP(t,e){function n(){const r=t.bucket,i=t.fullPath,s=new at(r,i);return e._makeStorageReference(s)}Object.defineProperty(t,"ref",{get:n})}function xP(t,e,n){const r={};r.type="file";const i=n.length;for(let s=0;s<i;s++){const o=n[s];r[o.local]=o.xform(r,e[o.server])}return NP(r,t),r}function g_(t,e,n){const r=f_(e);return r===null?null:xP(t,r,n)}function AP(t,e,n,r){const i=f_(e);if(i===null||!Eu(i.downloadTokens))return null;const s=i.downloadTokens;if(s.length===0)return null;const o=encodeURIComponent;return s.split(",").map(u=>{const c=t.bucket,h=t.fullPath,d="/b/"+o(c)+"/o/"+o(h),g=Ao(d,n,r),y=u_({alt:"media",token:u});return g+y})[0]}function y_(t,e){const n={},r=e.length;for(let i=0;i<r;i++){const s=e[i];s.writable&&(n[s.server]=t[s.local])}return JSON.stringify(n)}class Mi{constructor(e,n,r,i){this.url=e,this.method=n,this.handler=r,this.timeout=i,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
\r
`,d=`\r
--`+l+"--",g=En.getBlob(h,r,d);if(g===null)throw a_();const y={name:u.fullPath},v=Ao(s,t.host,t._protocol),T="POST",p=t.maxUploadRetryTime,f=new Mi(v,T,Zf(t,n),p);return f.urlParams=y,f.headers=o,f.body=g.uploadData(),f.errorHandler=Do(e),f}class El{constructor(e,n,r,i){this.current=e,this.total=n,this.finalized=!!r,this.metadata=i||null}}function ep(t,e){let n=null;try{n=t.getResponseHeader("X-Goog-Upload-Status")}catch{Zt(!1)}return Zt(!!n&&(e||["active"]).indexOf(n)!==-1),n}function bP(t,e,n,r,i){const s=e.bucketOnlyServerUrl(),o=w_(e,r,i),a={name:o.fullPath},l=Ao(s,t.host,t._protocol),u="POST",c={"X-Goog-Upload-Protocol":"resumable","X-Goog-Upload-Command":"start","X-Goog-Upload-Header-Content-Length":`${r.size()}`,"X-Goog-Upload-Header-Content-Type":o.contentType,"Content-Type":"application/json; charset=utf-8"},h=y_(o,n),d=t.maxUploadRetryTime;function g(v){ep(v);let T;try{T=v.getResponseHeader("X-Goog-Upload-URL")}catch{Zt(!1)}return Zt(Eu(T)),T}const y=new Mi(l,u,g,d);return y.urlParams=a,y.headers=c,y.body=h,y.errorHandler=Do(e),y}function UP(t,e,n,r){const i={"X-Goog-Upload-Command":"query"};function s(u){const c=ep(u,["active","final"]);let h=null;try{h=u.getResponseHeader("X-Goog-Upload-Size-Received")}catch{Zt(!1)}h||Zt(!1);const d=Number(h);return Zt(!isNaN(d)),new El(d,r.size(),c==="final")}const o="POST",a=t.maxUploadRetryTime,l=new Mi(n,o,s,a);return l.headers=i,l.errorHandler=Do(e),l}const Fg=256*1024;function $P(t,e,n,r,i,s,o,a){const l=new El(0,0);if(o?(l.current=o.current,l.total=o.total):(l.current=0,l.total=r.size()),r.size()!==l.total)throw eP();const u=l.total-l.current;let c=u;i>0&&(c=Math.min(c,i));const h=l.current,d=h+c,y={"X-Goog-Upload-Command":c===u?"upload, finalize":"upload","X-Goog-Upload-Offset":`${l.current}`},v=r.slice(h,d);if(v===null)throw a_();function T(w,I){const C=ep(w,["active","final"]),N=l.current+c,D=r.size();let Y;return C==="final"?Y=Zf(e,s)(w,I):Y=null,new El(N,D,C==="final",Y)}const p="POST",f=e.maxUploadRetryTime,m=new Mi(n,p,T,f);return m.headers=y,m.body=v.uploadData(),m.progressCallback=a||null,m.errorHandler=Do(t),m}const Je={RUNNING:"running",PAUSED:"paused",SUCCESS:"success",CANCELED:"canceled",ERROR:"error"};function vc(t){switch(t){case"running":case"pausing":case"canceling":return Je.RUNNING;case"paused":return Je.PAUSED;case"success":return Je.SUCCESS;case"canceled":return Je.CANCELED;case"error":return Je.ERROR;default:return Je.ERROR}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
